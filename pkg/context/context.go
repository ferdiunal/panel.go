...
// / ## DB Metodu
// /
// / GORM veritabanı bağlantısını alır.
// /
// / ### Açıklama
// / Bu metot, HTTP bağlamının Locals'ından "db" anahtarı altında
// / depolanan GORM veritabanı bağlantısını alır. Type assertion kullanarak
// / güvenli bir şekilde *gorm.DB türüne dönüştürür.
// /
// / ### Dönüş Değeri
// / - `*gorm.DB`: Veritabanı bağlantısı (nil olabilir)
// /
// / ### Kullanım Örneği
// / ```go
...
// /
// / ### Önemli Notlar
// / - DB middleware tarafından önceden ayarlanmış olması gerekir
// / - Nil döndürülmesi, veritabanı bağlantısının olmadığı anlamına gelir
// /
// / ### Avantajları
// / - Nil-safe erişim
// / - Panic'ten korunma
// / - Kolay veritabanı erişimi
